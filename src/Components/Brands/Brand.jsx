...
const Brand = () => {
    ...
    const [state, dispatch] = useReducer(ReducerFn, { brand: "redmi" });

    // Filter Products
    const filteredProducts = products.filter(
        product => state.brand === "all" ? product : product.brand === state.brand
    );
        ...
        <div className="container mt-5">
            ...
            <div className="mb-4 text-center">
                ...
                <button
                    ...
                    onClick={() => dispatch({ type: "SET_BRAND", payload: "apple" })}
                >
                    Apple
                </button>
                ...
                <button
                    className="btn btn-primary me-2"
                    onClick={() => dispatch({ type: "SET_BRAND", payload: "samsung" })}
                >
                    Samsung
                </button>
                ...
                <button
                    className="btn btn-primary me-2"
                    onClick={() => dispatch({ type: "SET_BRAND", payload: "redmi" })}
                >
                    Redmi
                </button>
                ...
                <button
                    className="btn btn-primary me-2"
                    onClick={() => dispatch({ type: "SET_BRAND", payload: "vivo" })}
                >
                    Vivo
                </button>
                ...
                <button
                    ...
                    onClick={() => dispatch({ type: "SET_BRAND", payload: "realme" })}
                >
                    Realme
                </button>
                ...
                <button
                    className="btn btn-primary"
                    onClick={() => dispatch({ type: "SET_BRAND", payload: "all" })}
                >
                    All
